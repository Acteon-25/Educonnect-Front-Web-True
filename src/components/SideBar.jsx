    ...
    <div className='bg-white py-3 fixed top-0 left-0 right-0 shadow-md'>
      ...
      <div className={`${open ? "w-80" : "w-0"} bg-cyan-600 min-h-screen fixed top-0 left-0 transition-all duration-300`}>
        <div className={`${!open && "hidden"} pt-3`}>
          ...
          <div className='text-center text-white text-xl hover:bg-orange-400 cursor-pointer py-3 mb-2'>Inicio</div>
          ...
          <div className='text-center text-white text-xl hover:bg-orange-400 cursor-pointer py-3 mb-2'>Configuracion</div>
        </div>
      </div>
    </div>
  )
