...
const HomePage = () => {
  ...
  return (
    ...
    <SectionContainer className="grid grid-cols-2 items-center my-8 pt-20">
      <h1 className="md:text-5xl text-3xl font-bold text-transparent bg-[#121212] bg-clip-text text-shadow-md text-center">Donde el conocimiento y el éxito se encuentran</h1>
