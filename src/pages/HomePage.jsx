...
const HomePage = () => {
  ...
  return (
    <>
    <Header />
    <SectionContainer className="grid grid-cols-2 items-center my-8 pt-20">
      <h1 className="md:text-5xl text-xl font-bold text-transparent bg-[#121212] bg-clip-text text-shadow-md text-center">Donde el conocimiento y el éxito se encuentran</h1>
    ...
    <SectionContainer className="text-center md:my-12 ">
      <div className="mb-8">
        <h2 className="text-3xl font-bold">Nuestros Éxitos</h2>
        <p className="text-lg mt-2 text-gray-700">Estamos orgullosos de la enseñanza que brindan nuestros asesores, pendientes siempre de la educación que se imparte a los alumnos</p>
      </div>
    ...
    <SectionContainer className="text-center my-12">
      <h2 className="text-3xl font-semibold mb-4">¿Qué tal es Educonnect?</h2>
      <p className="text-lg mb-8 text-gray-700">Es la mejor plataforma para conocer a los alumnos y asesores de la educación digital, y para compartir experiencias y conocimientos.</p>
      <div className="grid grid-cols-2 gap-4 px-8">
        <div className="bg-local bg-cover aspect-video w-full rounded-xl flex flex-col justify-center items-center text-white p-4" style={{ backgroundImage: `url(${Alumno})` }}>
          <h3 className="text-xl sm:text-3xl font-bold mb-3">Para estudiante</h3>
        ...
        <div className="bg-local bg-cover aspect-video w-full rounded-xl flex flex-col justify-center items-center text-white p-4" style={{ backgroundImage: `url(${Profesor})` }}>
          <h3 className="text-xl sm:text-3xl font-bold mb-3">Para asesor</h3>
